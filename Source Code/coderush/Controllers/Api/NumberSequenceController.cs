...
namespace coderush.Controllers.Api
{
    ...
    public class NumberSequenceController(ApplicationDbContext context) : Controller
    {
        ...
        public async Task<IActionResult> DeleteNumberSequence([FromRoute] int id)
        {
            ...
            NumberSequence numberSequence = await _context.NumberSequence.SingleOrDefaultAsync(m => m.NumberSequenceId == id);
        ...
        private bool NumberSequenceExists(int id) => _context.NumberSequence.Any(e => e.NumberSequenceId == id);
    }
}