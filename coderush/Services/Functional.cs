...
{
    public class Functional(UserManager<ApplicationUser> userManager,
       RoleManager<IdentityRole> roleManager,
       ApplicationDbContext context,
       SignInManager<ApplicationUser> signInManager,
       IRoles roles,
       IOptions<SuperAdminDefaultOptions> superAdminDefaultOptions) : IFunctional
    {
        ...
        private readonly SuperAdminDefaultOptions _superAdminDefaultOptions = superAdminDefaultOptions.Value;
            ...
            bool smtpSSL)
        {
            ...
            {
                To = { new MailAddress(toEmail, toFullName) },
